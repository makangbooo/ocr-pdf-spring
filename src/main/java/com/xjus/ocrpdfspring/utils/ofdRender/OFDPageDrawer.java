package com.xjus.ocrpdfspring.utils.ofdRender;
...
public class OFDPageDrawer extends PDFGraphicsStreamEngine {
    ...
    private com.xjus.ocrpdfspring.utils.ofdRender.OFDCreator ofdCreator;
    ...
    //    gs.setNonStrokingColor(new PDColor(new float[]{0, 0, 0, 0}, PDDeviceRGB.INSTANCE));
    //    gs.setStrokingColor(new PDColor(new float[]{0, 0, 0, 0}, PDDeviceRGB.INSTANCE));
    //    //super.showGlyph(textRenderingMatrix, font, code, unicode, displacement);
    //}
    ...
    protected OFDPageDrawer(int idx, PDPage page, com.xjus.ocrpdfspring.utils.ofdRender.OFDCreator ofdCreator, float scale) throws IOException {
        super(page);
        this.page = page;
    ...
    protected void showText(byte[] string) throws IOException {
        ...
        // 创建 RGBA 颜色（R, G, B, Alpha）
        
        $textObj.setFillColor(CT_Color.rgb(255,0,0));
        $textObj.setAlpha(0);
        queue.add($textObj);
    }
